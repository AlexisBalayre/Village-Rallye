...
export class RallyeQ2 extends React.Component<Props> {
  ...
  constructor(props: Props) {
    ...
    this.nombre_propositions = this.props.route.params.rallye.rallye.question2.nombre_reponses;
    this.photo = this.props.route.params.rallye.rallye.question2.photo_header;
    // Image 
    if (this.photo == true) {
        ...
        <ScrollView ref={this.ref} onContentSizeChange={() => this.ref.current.scrollToEnd({ animated: true })}>
          ...
          <View style={{flex:1, marginTop: 20, display: this.state.display}}>
              <View style={styles.button}>
                  <Button buttonStyle={{flex:1, height:70, borderRadius: 0, backgroundColor: 'black'}} containerStyle={{ flex:1,  borderRadius: 0}} title="CONFIRMER"  onPress={() => {this.props.navigation.navigate('ReponseScreen', {id_parcours, rallye, id_question, rallyes_reponse, score})}}/>
              </View>
          </View>
        </ScrollView>
      </View>
