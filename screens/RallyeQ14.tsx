...
type Props = StackScreenProps<RootStackParamList, 'RallyeQ14'>;

export class RallyeQ14 extends React.Component<Props> {
  ...
  constructor(props: Props) {
    ...
    this.nombre_propositions = this.props.route.params.rallye.rallye.question14.nombre_reponses;
    this.photo = this.props.route.params.rallye.rallye.question14.photo_header;
    // Image 
    if (this.photo == true) {
  ...
  ChangeColor1(rep:string){
      if (this.state.backgroundColor1 == '#2196F3') {
        if (this.state.nombre_reponses < this.props.route.params.rallye.rallye.question14.point) {
          var reponses = this.state.nombre_reponses + 1
          if (reponses == this.props.route.params.rallye.rallye.question14.point) {
            this.setState({
  ...
  render() {
    ...
    rallyes_reponse['question14'] = reponse;
      ...
      <View style={styles.main_container}>
        <ScrollView ref={this.ref} onContentSizeChange={() => this.ref.current.scrollToEnd({ animated: true })}>
          <Image
            ...
            source={rallye.rallye.question14.photo}
          />
          <Text style={styles.texte}>
            {rallye.rallye.question14.enonce}
            <Text style={styles.innerText}>{rallye.rallye.question14.question}</Text>
          </Text>
          <View style={styles.container}>
            <View style={{ flex: 1, marginTop: 18, display: this.displayBouton1}}>
                <Button buttonStyle={{borderRadius: 20, height: 45, backgroundColor: this.state.backgroundColor1}} containerStyle={{borderRadius: 20, flex:1}} title={rallye.rallye.question14.reponse1} onPress={() => {
                    this.ChangeColor1('A')
                }}/>
            </View>
            <View style={{ flex: 1, marginTop: 18, display: this.displayBouton2}}>
                <Button buttonStyle={{borderRadius: 20, height: 45, backgroundColor: this.state.backgroundColor2}}  containerStyle={{borderRadius: 20, flex:1}} title={rallye.rallye.question14.reponse2} onPress={() => {
                    this.ChangeColor2('B')
                }}/>
            </View>
            <View style={{ flex: 1, marginTop: 18, display: this.displayBouton3}}>
                <Button buttonStyle={{borderRadius: 20, height: 45, backgroundColor: this.state.backgroundColor3 }}  containerStyle={{borderRadius: 20, flex:1}} title={rallye.rallye.question14.reponse3} onPress={() => {
                    this.ChangeColor3('C')
                }}/>
            </View>
            <View style={{ flex: 1, marginTop: 18, display: this.displayBouton4}}>
                <Button buttonStyle={{borderRadius: 20, height: 45, backgroundColor: this.state.backgroundColor4 }}  containerStyle={{borderRadius: 20, flex:1}} title={rallye.rallye.question14.reponse4} onPress={() => {
                    this.ChangeColor4('D')
                }}/>
            </View>
            <View style={{ flex: 1, marginTop: 18, display: this.displayBouton5}}>
                <Button buttonStyle={{borderRadius: 20, height: 45, backgroundColor: this.state.backgroundColor5 }}  containerStyle={{borderRadius: 20, flex:1}} title={rallye.rallye.question14.reponse5} onPress={() => {
                    this.ChangeColor5('E')
                }}/>
            </View>
            <View style={{ flex: 1, marginTop: 18, display: this.displayBouton6}}>
                <Button buttonStyle={{borderRadius: 20, height: 45, backgroundColor: this.state.backgroundColor6 }}  containerStyle={{borderRadius: 20, flex:1}} title={rallye.rallye.question14.reponse6} onPress={() => {
                    this.ChangeColor6('F')
                }}/>
            </View>
            <View style={{ flex: 1, marginTop: 18, display: this.displayBouton7}}>
                <Button buttonStyle={{borderRadius: 20, height: 45, backgroundColor: this.state.backgroundColor7 }}  containerStyle={{borderRadius: 20, flex:1}} title={rallye.rallye.question14.reponse7} onPress={() => {
                    this.ChangeColor7('G')
                }}/>
            </View>
          </View>
